...
/*
Declare uma variável chamada `soma`, que receberá a função acima, passando como
parâmetro o operador de soma.
*/
let soma = calculator('+');

/*
Agora `soma` é uma função. Mostre no console a soma de dois números, usando ela.
*/
