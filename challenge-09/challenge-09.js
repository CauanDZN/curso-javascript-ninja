(function() {
    ...
    */
    ...
    /*
    Agora declare outra variáveis chamadas `subtracao`, `multiplicacao`,
    `divisao` e `mod`, e atribua à elas `calculator`, passando números
    diferentes para cada chamada.
    */
    
    var subtracao = calculator( 10, 20 );
    var multiplicacao = calculator( 10, 20 );
    var divisao = calculator( 10, 20 );
    ...
    */
    ...
    console.log( subtracao( function( num1, num2 ) {
        return num1 - num2;
    } ) );
