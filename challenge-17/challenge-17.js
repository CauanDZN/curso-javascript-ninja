(function() {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/, 'Francisco Cauan Victor da Silva Gonçalves'));
  ...
  */
  ...
  function replaceDate() {
    return text.replace(regexDate, function(capture, day, month, year) {
